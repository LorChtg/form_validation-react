    ...
    return (
      <form className="form" onSubmit={e => e.preventDefault()}>
        <label for="username"  class="field">
          ...
          <input type="text" id="username" name="user_name" required pattern={userNamePattern} />
          <span class="error" aria-live="polite"></span>
        </label>
        <label for="mail" class="field">
          <span class="label">Email address</span>
          <input type="email" id="email" name="user_email" required pattern={mailPattern} />
          <span class="error" aria-live="polite"></span>
        </label>
        <label for="password" class="field">
          <span class="label">Password</span>
          <input type="password" id="password" name="user_password" required pattern={passwordPattern} />
          <span class="error" aria-live="polite"></span>
        </label>
